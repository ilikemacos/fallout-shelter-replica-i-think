...
Download `dist/iwug.sh` from this repository, put it wherever you
...
to regenerate `dist/iwug.sh` after changing the source.
...
`dist/iwug.sh`). The macOS-specific window/audio/UI/app layer is
