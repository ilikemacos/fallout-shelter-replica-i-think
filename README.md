...
Download `dist/6767.sh` from this repository, put it wherever you
...
to regenerate `dist/6767.sh` after changing the source.
...
`dist/6767.sh`). The macOS-specific window/audio/UI/app layer is
