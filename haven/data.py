...
OBJECTIVES = [
    ("collect_5",     dict(kind="collect", n=5,
                           reward=dict(caps=40), desc="Collect from 5 rooms")),
    ...
    ("rush_3",        dict(kind="rush", n=3,
                           reward=dict(caps=120), desc="Successfully rush 3 rooms")),
    ("pop_10",        dict(kind="population", n=10,
                           reward=dict(caps=150), desc="Grow the shelter to 10 residents")),
    ("first_birth",   dict(kind="births", n=1,
                           reward=dict(caps=150), desc="Welcome a child into the shelter")),
    ("craft_3",       dict(kind="craft", n=3,
                           reward=dict(caps=180), desc="Craft 3 items")),
    ("pop_20",        dict(kind="population", n=20,
                           reward=dict(caps=300, lunchbox=1),
                           desc="Grow the shelter to 20 residents")),
    ...
    ("find_pa",       dict(kind="find_pa", n=1,
                           reward=dict(caps=500, lunchbox=1),
                           desc="Recover a suit of Power Armor")),
    ("kill_50",       dict(kind="kills", n=50,
                           reward=dict(caps=600, lunchbox=1), desc="Defeat 50 enemies")),
    ("pop_40",        dict(kind="population", n=40,
                           reward=dict(caps=800, lunchbox=1),
                           desc="Grow the shelter to 40 residents")),
    ("caps_2000",     dict(kind="caps_total", n=2000,
                           reward=dict(caps=250), desc="Earn 2000 bottle caps")),
    ("caps_10000",    dict(kind="caps_total", n=10000,
                           reward=dict(caps=1000, lunchbox=1),
                           desc="Earn 10000 bottle caps")),
]
