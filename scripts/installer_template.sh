...
#
#      ~/Downloads/__HAVEN_INSTALLER_NAME__
#
...
ensure_compiler() {
  ...
  fail "Waiting on Xcode Command Line Tools. Run this installer (~/Downloads/__HAVEN_INSTALLER_NAME__) again once that install finishes."
}
